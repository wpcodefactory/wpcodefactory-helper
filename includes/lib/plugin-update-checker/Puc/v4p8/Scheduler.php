...
//				add_action( 'admin_init', array($this, 'maybeCheckForUpdates') ); // commented by Algoritmika

				//Like WordPress itself, we check more often on certain pages.
				/** @see wp_update_plugins */
//				add_action('load-update-core.php', array($this, 'maybeCheckForUpdates')); // commented by Algoritmika
...
//					add_action($hook, array($this, 'maybeCheckForUpdates')); // commented by Algoritmika
//				}
				//This hook fires after a bulk update is complete.
//				add_action('upgrader_process_complete', array($this, 'upgraderProcessComplete'), 11, 2); // commented by Algoritmika
